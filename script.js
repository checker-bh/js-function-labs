...
Example: convertTemperature(32, 'C') should return [32, 89.6].
Example: convertTemperature(32, 'F') should return [32, 0].
...
const convertTemperature = (temperature, scale) => {
    ...
    if (scale === 'C'||scale === 'c') {
        ...
        return {temperature, convertedTemp};
...
const createUsername = (firstName, lastName) => {
    let firstThreeFirst = firstName.slice(0, 3);
    let firstThreeLast = lastName.slice(0, 3);
    let totalCharacters = firstName.length + lastName.length - 1; 
    let username = `${firstThreeFirst}${firstThreeLast}${totalCharacters}`;
